...
export type InputType = ScalarDefinition | ListDefinition | InputDefinition | InputDefaultDefinition | EnumDefinition<any, any> | ReferenceDefinition;
 ...
 */
export declare class FieldArgument {
    private name;
    private type;
